...
///
/// The backend host is configurable at build time so release builds can point
/// at a different deployment without a code change:
///   flutter build ... --dart-define=POKEDEX_API_BASE_URL=https://host/api/v2
class PokeApiService {
  static const String baseUrl = String.fromEnvironment(
    'POKEDEX_API_BASE_URL',
    defaultValue: 'https://poke-api.duocore.dev:158/api/v2',
  );
