...
class PokemonDBService {
  // Share the single, build-time-configurable base URL from PokeApiService so
  // there is one source of truth for the backend host.
  static const String _apiBaseUrl = PokeApiService.baseUrl;
