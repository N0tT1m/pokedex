      ...
      if (result == true) {
        ...
        if (name.isNotEmpty) {
          ...
          final fav = FavoritePokemon(
            ...
            spriteUrl:
                'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${_getDexNumber(name)}.png',
          );
          await _box!.add(fav);
          setState(() {});
        }
              ...
              ? const Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Tap + to add your favorite Pokemon!',
                    ...
                    return Card(
                      child: ListTile(
                        leading: fav.spriteUrl != null
                            ? Image.network(fav.spriteUrl!,
                                width: 48,
                                height: 48,
                                errorBuilder: (_, __, ___) =>
                                    const Icon(Icons.catching_pokemon))
                            : const Icon(Icons.catching_pokemon),
                        title: Text(_capitalize(fav.speciesName),
                            style:
