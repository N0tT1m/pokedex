...
class CompetitiveSetsScreen extends StatefulWidget {
  const CompetitiveSetsScreen({super.key});
...
class _CompetitiveSetsScreenState extends State<CompetitiveSetsScreen> {
    ...
    'lucario': [
      {
        ...
        'item': 'Life Orb',
        'evs': '252 Atk / 4 SpD / 252 Spe',
        'moves': ['Swords Dance', 'Close Combat', 'Bullet Punch', 'Crunch']
      },
      {
        'name': 'Special Attacker',
        'nature': 'Timid',
  ...
  void _selectPokemon(String name) {
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: const Text('Competitive Sets'), backgroundColor: Colors.red),
      body: _isLoading
                ...
                children: [
                  ...
                  if (_selectedPokemon != null) ...[
                    ...
                    if (_sets.containsKey(_selectedPokemon!.toLowerCase()))
                      ..._sets[_selectedPokemon!.toLowerCase()]!
                          .map(_buildSetCard)
                    else
                      const Card(
                        child: Padding(
                          ...
                          child: Text(
                              'No competitive sets available for this Pokemon.\n\n'
                  ...
                  if (_selectedPokemon == null) ...[
                    ...
                    const Text('Popular Pokemon with Sets:',
